...
if(doPlot){
  ...
  pdf(paste0("output/had4/OM_plots/OM_",omName,"_",stkname,"_parameter uncertainty - checks.pdf"), height=7, width=11,paper="a4r")
...
for(i in 1:length(eqSim_yrs)){
  ...
  if (i==1){
    plot(ages,c(tmp[,ac(eqSim_yrs[i])]),main="Selectivities 2008:2017",type="l",col=cols[i],ylim=range(tmp))
  }else{
